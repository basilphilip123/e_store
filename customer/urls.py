...
path("products/details/<int:id>",views.ProductDetailView.as_view(),name="product-details"),
path("products/carts/<int:id>/add",views.addto_cart,name="add-cart"),
path("carts/all",views.CartListView.as_view(),name="cart-list"),
path("carts/<int:id>/delete",views.CartDeleteView.as_view(),name="cart-delete"),
